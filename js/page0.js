...
const q1 = {
    ...
    alternativaA : " A = l x l",
    alternativaB : "A = b x h",
    alternativaC : " A = (b x h)/2",
    correta      : " A = (b x h)/2",
}

const q2 = {
    numQuestao   : 2,
    pergunta     : "Qual é o resultado de 10 - 6 x 2?",
    alternativaA : "2",
    alternativaB : "-2",
    alternativaC : "12", 
    correta      : "-2",
...
const q4 = {
    numQuestao   : 4,
    pergunta     : "Dois pais e dois filhos sentaram-se para comer ovos no café da manhã. Cada um comeu um ovo. Quanto os ovos eles comeram no total?",
    alternativaA : "1",
    alternativaB : "3",
    alternativaC : "5",
    correta      : "3",
